    ...
    @for ($i = 0; $i < 4; $i++) @if ($i % 2 !==0)
        <div class="col-12 d-flex border-bottom mt-4">
            <div class="col-9 d-flex justify-content-end">
                <div class="col-8">
                    <a class="fs-30 fw-bold text-dark text-decoration-none" href="{{ route('blog.workDetail', ['id' => 1]) }}">36 Days of Malayalam type</a>
            ...
            <div class="col-3 d-flex justify-content-center mb-3">
                <img class="rounded" src="{{ asset('img/rectangle2.png') }}" width="90%" height="91%">
            </div>
        </div>
        @else
        <div class="col-12 d-flex border-bottom mt-4">
